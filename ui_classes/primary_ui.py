...
from .shared_imports import BoxLayout, GridLayout, Label, TextInput, Button, Popup, ScrollView
from .scrollable_spinner import ScrollableSpinner
from assets import CURRENCIES,STANDARD_SET,OTHER_PAIRS,OTHER_INSTRUMENTS
...
class PrimaryUI(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.acc_curr = ScrollableSpinner(text="Select From: ", values=CURRENCIES)
        ...
        self.stock_curr = ScrollableSpinner(text="Select From: ", values=CURRENCIES)
        ...
        self.inst_spinner = ScrollableSpinner(
            text="View Other Instruments", values=sorted(other_insts)
        )
